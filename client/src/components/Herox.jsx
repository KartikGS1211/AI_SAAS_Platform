...
const Hero = () => {
  ...
  return (
    <div className='px-4 sm:px-20 xl:px-32 relative inline-flex
        ...
        max-sm:text-xs text-gray-600'>Transform your content creation with 
        our suite of premium AI tools.
        Write articles, generate images, and enhance your workflow.</p>
        </div>
      <div className='flex flex-wrap justify-center gap-4 text-sm max-sm:text-xs'>
        <button onClick={()=> navigate('/ai')} className='bg-blue-500 text-white px-10 py-3
        rounded-lg hover:scale-102 active:scale-95 transition cursor-pointer'>
       ...
       <div className='flex items-center gap-4 mt-8 mx-auto text-gray-600'>
        <img src={user_group} alt="usergroup" className='h-8' />
        Trusted by10k+
       </div>
    </div>
  )
