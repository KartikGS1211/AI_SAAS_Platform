...
const WriteArticle = () => {
  const articleLength = [
    { label: 'Short (200-400 words)', text: 'short' },
    { label: 'Medium (400-800 words)', text: 'medium' },
    { label: 'Long (800-1200 words)', text: 'long' },
    { label: 'Very Long (1200+ words)', text: 'very-long' },
  ]
